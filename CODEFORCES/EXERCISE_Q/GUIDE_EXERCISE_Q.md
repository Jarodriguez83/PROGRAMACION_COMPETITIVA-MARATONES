...
La primera línea contiene una palabra s, la segunda línea contiene una palabra t. Las palabras constan de letras latinas minúscula. Los datos de entrada no contienen espacios innecesarios. Las palabras no están vacías y su longitud no supera los 100 símbolos.  

## **SALIDA:**

Si la palabra t es una palabra s, escrito al revés, imprimir "YES", de lo contrario imprimir "NO".  
